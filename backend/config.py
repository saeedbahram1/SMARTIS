...
SMARTIS_AMBIENT_CALIBRATION_SECONDS = _env_float("SMARTIS_AMBIENT_CALIBRATION_SECONDS", 0.7)
SMARTIS_PHRASE_TIME_LIMIT_SECONDS = _env_float("SMARTIS_PHRASE_TIME_LIMIT_SECONDS", 18.0)
SMARTIS_PAUSE_THRESHOLD = _env_float("SMARTIS_PAUSE_THRESHOLD", 1.0)
SMARTIS_NON_SPEAKING_DURATION = _env_float("SMARTIS_NON_SPEAKING_DURATION", 0.45)
SMARTIS_PHRASE_THRESHOLD = _env_float("SMARTIS_PHRASE_THRESHOLD", 0.12)

# Timeouts
SMARTIS_GOOGLE_TIMEOUT = _env_float("SMARTIS_GOOGLE_TIMEOUT", 6.0)
